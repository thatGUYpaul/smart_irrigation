            ...
            <tbody>
                <?php while ($user = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_user.php?user_id=<?php echo $user['id']; ?>" class="action-btn">Update User</a>
                        </td>
                        <td>
                            <a href="?delete_user_id=<?php echo $user['id']; ?>" class="action-btn delete-btn">Delete User</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
